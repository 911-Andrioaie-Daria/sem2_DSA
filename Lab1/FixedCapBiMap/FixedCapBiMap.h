...
class FixedCapBiMap {
	...
	private:
		TElem* elements;
		int capacity;
		int number_of_pairs; // current number of pairs stored in the container
    ...
    //If k had 2 associated values, these are in valuePair.If k had 1 associated value, that value is the first component of the ValuePair, the second component is NULL_TVALUE
